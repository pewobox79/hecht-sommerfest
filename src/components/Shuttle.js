...
function Shuttle() {
    return (
        <ShuttleField>
            ...
            <ShuttleBody>Ab ca. <SpanStyle>22.00 Uhr</SpanStyle> bieten wir einen Shuttle zwischen <SpanStyle>Pörnbach, Pfaffenhofen</SpanStyle> und <SpanStyle>Schrobenhausen</SpanStyle> an. Bitte gib uns bei Deiner Anmeldung
